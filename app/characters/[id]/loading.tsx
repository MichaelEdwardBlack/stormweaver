  ...
  return (
    <div className="flex items-center justify-center h-[70vh]">
      ...
      >
        ...
        <p className="mt-5 font-medium text-neutral-700 dark:text-neutral-300">Loading…</p>

        <p className="mt-1 text-sm text-neutral-500">Preparing and loading the character editor</p>
      </motion.div>
    </div>
  );
}
